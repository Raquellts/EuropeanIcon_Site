...
export const porto2026: EventEdition = {
  ...
  participants: [
    "bruno-perez-de-almeida-lopes",
    "davide-rodrigues",
    "renato-coletti-de-barros",
    "magalhaes-barbosa-junior",
    "carolina-porto",
    "debora-cristina-de-alcantara-ferreira",
    "emilia-do-carmo-afonso-ferreira-estrangeiro",
    "isabela-fragoso-blanco",
    "karina-bagnatori",
    "kelly-soares",
    "marcela-camargo",
    "marcia-haidee-evangelista-bezerra",
    "marianna-guimarães-figueiredo",
    "michela-cunto",
    "rayanne-monteiro-andrade",
    "roberta-gadelha-dos-santos",
    "sofia-alexandra-goncalves-nunes",
    "solbei-karina-ferreira-delpino",
    "valeria-bordini-starling-de-carvalho",
    "vanessa-lopes-gama",
    "maria-joao-crispim-rebelo-guinote",
    "tatianne-caldeira-de-oliveira",
    "adriano-teixeira-guimaraes",
    "antonio-jose-roma-de-magalhaes-filipe",
    "catarina-zuccaro",
    "monica-costa",
    "sonia-donoso-de-barros",
    "tatiana-costa-mota",
    "teresa-carlota-dias-goncalves-cortesao-martinho",
    "walber-ribeiro-dassumpcao",
    "miguel-mateus-teixeira",
    "convidado",
  ],
  schedule: [
    {
